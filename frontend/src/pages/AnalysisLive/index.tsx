...
import { renderMarkdown as renderMarkdownBase, parseReport } from '../../utils/markdown';

// =============================================================================
// Utilities
// =============================================================================

/** Dark-themed markdown renderer (delegates to shared utility) */
function renderMarkdown(text: string): string {
  return renderMarkdownBase(text, 'dark');
}

/** Extract text from a report field (delegates to shared parseReport utility) */
const extractReportText = parseReport;
